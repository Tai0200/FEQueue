...
const NewQueueForm = (props: NewQueueFormProps) => {
  ...
  const handleFinish = async (values: any) => {
    ...
    try {
      const response = await fetchWithTokenRetry(process.env.REACT_APP_API_URL + 'api/Assignment/', {
        method: 'POST',
        body: JSON.stringify({
          code: 'abc', customerName: values.customerName, telephone: values.telephone, status: 0, deviceCode: 'KIO_06',
